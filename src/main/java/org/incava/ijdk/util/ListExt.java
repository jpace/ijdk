...
public class ListExt extends CollectionExt {
    ...
    public static <T> T first(List<T> list) {
        return new org.incava.ijdk.collect.DynamicArray<T>(list).first();
    }
    ...
    public static <T> T last(List<T> list) {
        return new org.incava.ijdk.collect.DynamicArray<T>(list).last();
    }
    ...
    public static <T> T get(List<T> list, int index) {
        return new org.incava.ijdk.collect.DynamicArray<T>(list).get(index);
    }
    ...
    public static <Type> Type getRandomElement(List<Type> list) {
        return new org.incava.ijdk.collect.DynamicArray<Type>(list).getRandomElement();
    }
